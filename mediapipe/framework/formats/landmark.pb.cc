...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, sizeof(::mediapipe::Landmark)},
  { 13, -1, sizeof(::mediapipe::LandmarkList)},
  { 19, 28, sizeof(::mediapipe::NormalizedLandmark)},
  { 32, -1, sizeof(::mediapipe::NormalizedLandmarkList)},
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fframework_2fformats_2flandmark_2eproto = {
  false, false, descriptor_table_protodef_mediapipe_2fframework_2fformats_2flandmark_2eproto, "mediapipe/framework/formats/landmark.proto", 378,
...
static bool dynamic_init_dummy_mediapipe_2fframework_2fformats_2flandmark_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fframework_2fformats_2flandmark_2eproto)), true);
namespace mediapipe {
...
Landmark::Landmark(const Landmark& from)
  ...
  ::memcpy(&x_, &from.x_,
    ...
    reinterpret_cast<char*>(&x_)) + sizeof(visibility_));
...
void NormalizedLandmark::InternalSwap(NormalizedLandmark* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(NormalizedLandmark, visibility_)
      + sizeof(NormalizedLandmark::visibility_)
