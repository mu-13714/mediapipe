...
class MatrixData PROTOBUF_FINAL :
 ...
 public:
  ...
  protected:
  explicit MatrixData(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  static inline bool Layout_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      Layout* value) {
