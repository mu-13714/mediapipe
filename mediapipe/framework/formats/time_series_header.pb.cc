...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fframework_2fformats_2ftime_5fseries_5fheader_2eproto = {
  false, false, descriptor_table_protodef_mediapipe_2fframework_2fformats_2ftime_5fseries_5fheader_2eproto, "mediapipe/framework/formats/time_series_header.proto", 319,
...
static bool dynamic_init_dummy_mediapipe_2fframework_2fformats_2ftime_5fseries_5fheader_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fframework_2fformats_2ftime_5fseries_5fheader_2eproto)), true);
namespace mediapipe {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          num_streams_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
