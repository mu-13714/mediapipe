...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fframework_2fformats_2fannotation_2frasterization_2eproto = {
  false, false, descriptor_table_protodef_mediapipe_2fframework_2fformats_2fannotation_2frasterization_2eproto, "mediapipe/framework/formats/annotation/rasterization.proto", 266,
...
static bool dynamic_init_dummy_mediapipe_2fframework_2fformats_2fannotation_2frasterization_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_mediapipe_2fframework_2fformats_2fannotation_2frasterization_2eproto)), true);
namespace mediapipe {
